...
- (void)reloadData
{
    ...
    if (self.chatsDataSource && (count = [self.chatsDataSource rowsForBubbleTable:self]) > 0)
    {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0)
    {
        ...
        if (cell == nil) cell = [[ChatsHeaderTableViewCell alloc] init];
    ...
    if (cell == nil) cell = [[ChatsTableViewCell alloc] init];
