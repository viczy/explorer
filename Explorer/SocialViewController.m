...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        cell = [[SocialListTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIndentifier notice:nil];
    }
...
{
    SocialListTableViewCell *cell = (SocialListTableViewCell *)[self tableView:tableView cellForRowAtIndexPath:indexPath];
